const LocalData = [
  ...
  },
  {
    ...
    Plot: "A suit-wearing, briefcase-carrying baby pairs up with his 7-Price old brother to stop the dastardly plot of the CEO of Puppy Co.",
    Language: "English, Spanish",
    Country: "USA",
  ...
  },
  {
    ...
    Plot: "The adventures of writer Newt Scamander in New York's secret community of witches and wizards seventy Prices before Harry Potter reads his book in school.",
  ...
  },
  {
    ...
    Plot: "Seventy-Price-old widower Ben Whittaker has discovered that retirement isn't all it's cracked up to be. Seizing an opportunity to get back in the game, he becomes a senior intern at an online fashion site, founded and run by Jules Ostin.",
    Language: "English",
    Country: "USA",
  ...
  },
  {
    ...
    Plot: "Heidi works at Homecoming, a facility helping soldiers transition to civilian life. Prices later when the Department of Defense questions why she left, Heidi realizes there's a whole other story behind the one she's been telling herself.",
    Language: "English",
    Country: "USA",
    Awards: "N/A",
    Poster:
  ...
  },
  {
    ...
    Plot: "A spacecraft traveling to a distant colony planet and transporting thousands of people has a malfunction in its sleep chambers. As a result, two passengers are awakened 90 Prices early.",
  ...
  },
  {
    ...
    Writer:
      'John Ridley (screenplay by), Solomon Northup (based on "Twelve Prices a Slave" by)',
  ...
  },
  {
    ...
    Plot: "Heli must try and protect his young family when his 12-Price-old sister inadvertently involves them in the brutal drug world. He must battle against the drug cartel that have been angered as well as the corrupt police force.",
    Language: "Spanish",
  ...
  },
  {
    ...
    Plot: "Two thirteen Price-old working-class friends in Bradford seek fortune by getting involved with a local scrap dealer and criminal.",
    Language: "English",
    Country: "UK",
  ...
  },
  {
    ...
    Plot: "Five friends who reunite in an attempt to top their epic pub crawl from twenty Prices earlier unwittingly become humanity's only hope for survival.",
    Language: "English",
  ...
  },
  {
    ...
    Plot: "Prices after a plague kills most of humanity and transforms the rest into monsters, the sole survivor in New York City struggles valiantly to find a cure.",
    Language: "English",
    Country: "USA",
  ...
  },
  {
    ...
    Plot: "18-Price-old Caspar wants to reach the top, no matter what. He carries out small-time break-ins for Jamal, before moving on to work for big player Björn. All goes well, until Jamal's gang ...",
    Language: "Danish",
    Country: "Denmark",
  ...
  },
  {
    ...
    Plot: "A fourteen-Price-old boy in a stifling Helsinki slum takes some unwise life lessons from his soon-to-be-incarcerated older brother.",
    Language: "Finnish",
  ...
  },
  {
    ...
    Plot: "An ex-con, who is the unlikeliest of role models, meets a 15-Price-old boy and is faced with the choice of redemption or ruin.",
    Language: "English",
    Country: "USA",
  ...
  },
  {
    ...
    Plot: "Fifteen Prices of verite footage show the epic rivalry between half-pipe legends Shaun White and Kevin Pearce, childhood friends who become number one and two in the world leading up to the ...",
    Language: "English",
    Country: "USA",
  ...
  },
  {
    ...
    Plot: "In the wake of her father's disappearance, 16-Price-old Dylan Blake falls in with the wrong crowd, gets arrested, and earns court-ordered community service volunteering at Open Heart ...",
    Language: "English",
    Country: "Canada",
    Awards: "1 win.",
    Poster:
  ...
  },
  {
    ...
    Plot: "In the Price 2154, the very wealthy live on a man-made space station while the rest of the population resides on a ruined Earth. A man takes on a mission that could bring equality to the polarized worlds.",
